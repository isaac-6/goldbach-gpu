// sieve_kernel.cuh
// THROWAWAY MEASUREMENT HEADER -- NOT FOR RELEASE.
//
// tiled_sieve_segment_kernel extracted byte-identically from
// v2.0.0 src/goldbach.cu so that test_gpu_sieve can link against it.
// The D1 defect (non-atomic shared-memory read-modify-write) is INTACT and
// deliberately so: this header exists only to quantify that defect.
