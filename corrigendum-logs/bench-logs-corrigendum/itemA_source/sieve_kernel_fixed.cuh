// sieve_kernel_fixed.cuh
// MEASUREMENT HEADER -- NOT PART OF THE BUILD.
//
// tiled_sieve_segment_kernel extracted byte-identically from v2.0.2
// src/goldbach.cu lines 200-265. It differs from sieve_kernel.cuh, the
// v2.0.0 extraction in this directory, only in the D1 fix: the shared-memory
// clear is an atomicAnd.
